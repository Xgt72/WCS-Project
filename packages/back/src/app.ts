...
app.get(
  '/getAllIndicators',
  [verifyToken],
  indicatorController.getAllIndicators
);
app.get(
  '/getIndicatorsByPlayerId/:id',
  [verifyToken],
  indicatorController.getIndicatorsByPlayerId
);
app.get(
  '/getIndicatorById/:id',
  [verifyToken],
...
app.get(
  '/getAllIndicatorsByPlayerIdAndName/:id/:name',
  indicatorController.getAllIndicatorsByPlayerIdAndName
);
...
app.get(
  '/getMutatorsById/:id',
  [verifyToken],
  mutatorController.getMutatorsById
);
...
app.delete(
  '/deleteMutator/:id',
  [verifyToken],
  mutatorController.deleteMutator
);
...
app.get(
  ...
  [verifyToken],
  playerBuildingsController.getAllPlayersBuildings
);
app.get(
  '/getOnePlayerBuildings/:id',
  [verifyToken],
  playerBuildingsController.getOnePlayerBuildings
);
app.get(
  '/getPlayerBuildingById/:id',
  [verifyToken],
  playerBuildingsController.getPlayerBuildingById
);
app.get(
  '/getAllBuildingTemplates',
  [verifyToken],
  playerBuildingsController.getAllBuildingTemplates
);
app.post(
  '/savePlayerBuilding',
  [verifyToken],
  playerBuildingsController.savePlayerBuilding
);
app.post(
  '/updatePlayerBuilding',
  [verifyToken],
  playerBuildingsController.updatePlayerBuilding
);
app.delete(
  '/deletePlayerBuilding/:id',
  [verifyToken],
  playerBuildingsController.deletePlayerBuilding
);
...
app.get(
  ...
  [verifyToken],
  playerTeacherController.getAllPlayersTeachers
);
app.get(
  '/getOnePlayerTeachers/:id',
  [verifyToken],
  playerTeacherController.getOnePlayerTeachers
);
app.get(
  '/getPlayerTeacherById/:id',
  [verifyToken],
  playerTeacherController.getPlayerTeacherById
);
app.post(
  '/savePlayerTeacher',
  [verifyToken],
  playerTeacherController.savePlayerTeacher
);
app.post(
  '/updatePlayerTeacher',
  [verifyToken],
  playerTeacherController.updatePlayerTeacher
);
app.delete(
  '/deletePlayerTeacher/:id',
  [verifyToken],
  playerTeacherController.deletePlayerTeacher
);
...
app.get(
  ...
  [verifyToken],
  teacherActivitiesCalendarController.getAllTeachersActivitiesCalendar
);
app.get(
  '/getTeacherActivityCalendarById/:id',
  [verifyToken],
  teacherActivitiesCalendarController.getTeacherActivityCalendarById
);
app.get(
  '/getTeacherActivitiesCalendarByTeacherId/:id',
  [verifyToken],
  teacherActivitiesCalendarController.getTeacherActivitiesCalendarByTeacherId
);
app.get(
  '/getActivityByTeacherIdByDayByPeriod/:id/:day/:period',
  [verifyToken],
  teacherActivitiesCalendarController.getActivitiesByTeacherIdAndByDayByPeriod
);
app.post(
  '/saveTeacherActivity',
  [verifyToken],
  teacherActivitiesCalendarController.saveTeacherActivity
);
app.post(
  '/saveMultipleActivitiesTeacher',
  [verifyToken],
  teacherActivitiesCalendarController.saveMultipleActivitiesTeacher
);
app.post(
  '/updateTeacherActivityCalendar',
  [verifyToken],
  teacherActivitiesCalendarController.updateTeacherActivityCalendar
);
app.delete(
  '/deleteTeacherActivityCalendar/:id',
  [verifyToken],
  teacherActivitiesCalendarController.deleteTeacherAcitvityCalendar
);
...
app.get(
  ...
  [verifyToken],
  playerCampusManagerController.getAllPlayersCampusManagers
);
app.get(
  '/getOnePlayerCampusManagers/:id',
  [verifyToken],
  playerCampusManagerController.getOnePlayerCampusManagers
);
app.get(
  '/getPlayerCampusManagerById/:id',
  [verifyToken],
  playerCampusManagerController.getPlayerCampusManagerById
);
app.post(
  '/savePlayerCampusManager',
  [verifyToken],
  playerCampusManagerController.savePlayerCampusManager
);
app.post(
  '/updatePlayerCampusManager',
  [verifyToken],
  playerCampusManagerController.updatePlayerCampusManager
);
app.delete(
  '/deletePlayerCampusManager/:id',
  [verifyToken],
  playerCampusManagerController.deletePlayerCampusManager
);
...
app.post(
  '/saveAllActivities',
  [verifyToken],
  activityController.saveAllActivities
);
...
app.post(
  '/hireCampusManager',
  [verifyToken],
  hireCampusManagerController.hireCampusManager
);
...
app.post(
  ...
  [verifyToken],
  campusManagerCalendarController.addActivitiesInCampusManagerCalendar
);
...
app.post(
  ...
  [verifyToken],
  teacherCalendarController.addActivitiesInTeacherCalendar
);
